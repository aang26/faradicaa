...
?>
        ...
        <head>
            ...
            <title>Daisy's Wardrobe | Product Details</title>
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="product-details-content-area product-details--golden" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="product-details-text">
                                    ...
                                    <div class="price fw-bolder">IDR <?php echo $pd["newPrice"] ?>  <span style="font-size: medium;"></span> <?php
                                                                                                                                                                                                if ($pd["discount"] != 0) {
                                                                                                                                                                                                ?>
                                                ...
                                                <div class="variable-single-item">
                                                    ...
                                                    <select class="product-variable-size border-dark" id="color_set" onchange="auto_size(); auto_img_set(<?php echo $pid ?>);">
                                                        ...
                                                        ?>
                                                            ...
                                                            if (empty($clr_v)) {
                                                            ?>
                                                                <option value="<?php echo $stock_id; ?>">Unknown Color</option>
                                                            <?php
                                                            } else {
                                                            ?>
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-5 col-md-4">
                                                <div id="qty_div">
                                                    <span id="qty_set">Please select color & size</span>
                                                </div>
                                            </div>
