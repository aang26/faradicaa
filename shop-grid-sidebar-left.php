...
<head>
    ...
    <title>Daisy's Wardrobe | Shop</title>
                ...
                <div class="col-lg-3">
                    ...
                    <div class="siderbar-section" data-aos="fade-up" data-aos-delay="0">
                        ...
                        <div class="sidebar-single-widget">
                            ...
                            <select name="" id="clr" class="form-select" onclick="advancedSearch(0);">
                                                        ...
                                                        <div class="product-default-single-item product-color--golden" data-aos="fade-up" data-aos-delay="0">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="content-right">
                                                                    <span class="price">
                                                                        <h3>IDR <?php echo $productData["newPrice"]; ?>  </h3>&nbsp;

                                                                        <?php
                                                                        if ($productData["discount"] != 0) {
                                                                        ?>
                                                                            <del class="text-danger">IDR <?php echo $productData["price"]; ?> </del>
                                                                    </span>
                                                                <?php
                                                                        }
                                                                ?>
