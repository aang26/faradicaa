...
<body>
    ...
    <!-- Start Header Area -->
    <header style="position: static; z-index: 999; width: 100%; background-color: rgba(0, 0, 0, 1.0);" class="header-section d-none d-xl-block">
                    ...
                    <div class="row">
                        <div class="col-12 d-flex align-items-center justify-content-between">
                            ...
                            <div class="header-logo">
                                <div class="logo">
                                    <a href="index.php"><img src="assets/images/logo/test.png" alt=""></a>
                                </div>
                            </div>
                            <!-- End Header Logo -->
                                        ...
                                        ?>
                                            <li class="logi-div">
                                                <a href="my_account.php">
                                                    ...
                                                    if ($gender == 1) {
                                                    ?>
                                                        <span class="d-signin1"><?php echo $fname; ?></span>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <span class="d-signin1"><?php echo $fname; ?></span>
