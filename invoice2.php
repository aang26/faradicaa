...
?>
    ...
    <head>
        ...
        <title>Daisy's Wardrobe | Invoice</title>
        ...
        <script>
            function createPDF() {
                ...
                html2pdf(element, {
                    margin: 1,
                    padding: 0,
                    filename: 'Daisy\'s Wardrobe invoice.pdf',
                    image: {
                        type: 'jpeg',
                        quality: 1
                    },
                            ...
                            <table class="table">
                                ...
                                ?>
                                    ...
                                    <tr style="height: 70px;">
                                        ...
                                        <td class="fs-6 text-end pt-3" style="background-color: rgb(199,199,199);">IDR <?php echo $unit_price ?></td>
                                        <td class="fs-6 text-end pt-3"><?php echo $irs["qty"]; ?></td>
                                        <td class="fs-6 text-end pt-3 bg-danger text-white">IDR <?php echo $irs["total"] ?> </td>
                                    </tr>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="fs-5 text-end">IDR <?php echo $st ?> </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="border-0"></td>
                                        <td colspan="2" class="fs-5 text-end border-success">Courier</td>
                                        <td class="fs-5 text-end border-danger">IDR <?php echo $delivery ?> </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2" class="border-0"></td>
                                        <td colspan="2" class="fs-5 text-end border-0 text-success">GRAND TOTAL</td>
                                        <td class="fs-5 text-end border-0 text-success">IDR <?php echo $st + $delivery ?> </td>
                                    </tr>
