...
<head>
    ...
    <title>Daisy's Wardrobe | Login</title>
                                    ...
                                    <div class="col-12 align-self-center">
                                        <div class="row gy-2">
                                            ...
                                            <div class="col-12 col-lg-6">
                                                ...
                                                <input type="number" class="form-control  shadow-sm bg-grey-light border-0 rounded-pill fw-lighter fs-7 p-3" id="mobile" placeholder="08******">
                                            </div>
