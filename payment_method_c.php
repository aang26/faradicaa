...
<head>
    ...
    <title>Daisy's Wardrobe | Payment</title>
                                                        ...
                                                        $totalll= number_format($total+$delivery,3);
                                                            ...
                                                            <tr>
                                                                <th scope="row" style="text-align: right;" colspan="5">
                                                                    Delivery fee: &nbsp; IDR <?php echo $delivery ?>
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row" style="text-align: right;" colspan="5">
                                                                    Total: &nbsp; IDR <?php echo $totalll ?>
                                                                </th>
