...
?>
    ...
    <head>
        ...
        <title>Daisy's Wardrobe | Cart</title>
                                            ...
                                            <table>
                                                ...
                                                <tbody>
                                                    ...
                                                    for ($i = 0; $i < $cn; $i++) {
                                                        ...
                                                        $totall= number_format($total,3);

                                                        $totalll= number_format($total+$delivery,3);
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <input disabled class="form-control text-center" min="1" max="100" value="<?php echo $cr["qty"]; ?>" type="number" onchange="cartupdate(<?php echo $cr['id'] ?>);autoprice(<?php echo $cr['id'] ?>);" id="qtyup<?php echo $cr["id"]; ?>"></td>
                                                            <td class="product_total" id="price<?php echo $cr["id"] ?>">IDR <?php echo $cr["unit_price"]; ?></td>
                                    ...
                                    <div class="coupon_code right" data-aos="fade-up" data-aos-delay="400">
                                        ...
                                        <div class="coupon_inner">
                                            ...
                                            <div class="cart_subtotal">
                                                <p>Total Items</p>
                                                <p class="cart_amount" id="sub"><?php echo $cart_sumqty; ?></p>
                                            </div>
                                            <div class="cart_subtotal">
                                                <p>Subtotal</p>
                                                <p class="cart_amount" id="sub">IDR <?php echo $totall; ?> </p>
                                            </div>
                                            <div class="cart_subtotal ">
                                                <p>Courier</p>
                                                <p class="cart_amount">IDR <?php echo $delivery ?> </p>
                                            </div>
                                            <div class="cart_subtotal">
                                                <p class="text-danger">Total</p>
                                                <p style="font-size: 2em;" class="cart_amount text-danger" id="tot">IDR <?php echo $totalll ?> </p>
                                            </div>
